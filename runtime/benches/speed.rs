...
// use runtime::{Runtime, variable::{Truthy, Value, Variable}, RuntimeError};
// use log::{ error, warn, info, };

// fn init_runtime(runtime: &mut Runtime) { 
//     runtime.add_function("eq".into(), |_, args| { 
//         if args.len() != 2 { 
//             return Err(RuntimeError::RuntimeError("InvalidArgumentLenght".into(), "Expected 2 Arguments".into()))
//         }
